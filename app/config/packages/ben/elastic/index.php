		...
		"indices" => [
			...
			[
				...
				"definition" => [
					...
					"source" => [
						"type" => "json",
						"location" => ["http://public-data.lordsandknights.com/LKWorldServer-US-12/alliances.json.gz"],
					],
					"transformers" => [],
				],
			],
			[
				...
				"definition" => [
					...
					"source" => [
						"type" => "json",
						"location" => ["http://public-data.lordsandknights.com/LKWorldServer-US-12/players.json.gz"],
					],
					"transformers" => [],
				],
			],
			[
				...
				"definition" => [
					...
					"source" => [
						"type" => "json",
						"location" => ["http://public-data.lordsandknights.com/LKWorldServer-US-12/habitats.json.gz"],
					],
					"transformers" => [],
				],
			],
